...
@Stateless
public class DaoTypExam extends BaseDao<TabTypExam, String> implements IDaoTypExam{
	
	private static BaseLogger logger = BaseLogger.getLogger(DaoTypExam.class); 
	...
	public <X extends BaseEntity> List<X> findByExample(X entity)
		...
		TabTypExam currentTypExam = (TabTypExam)entity;
		if(currentTypExam.getCodTypExam()!= null && !currentTypExam.getCodTypExam().equals("")){
			clauseWhere = clauseWhere + "AND upper(o.codTypExam) like '%"+currentTypExam.getCodTypExam()+"%'";
		}
		if(currentTypExam.getLibTypExam()!= null && !currentTypExam.getLibTypExam().equals("")){
			clauseWhere = clauseWhere + "AND upper(o.libTypExam) like '%"+currentTypExam.getLibTypExam()+"%'";
		}
		try{
