...
@Stateless
public class DaoSoc extends BaseDao<TabSoc, String> implements IDaoSoc{
	
private static BaseLogger logger = BaseLogger.getLogger(DaoSoc.class); 
	...
	public <X extends BaseEntity> List<X> findByExample(X entity)
		...
		TabSoc currentSoc = (TabSoc)entity;
		if(currentSoc.getCodSoc()!= null && !currentSoc.getCodSoc().equals("")){
			clauseWhere = clauseWhere + "AND upper(o.codSoc) like '%"+currentSoc.getCodSoc()+"%'";
		}
		if(currentSoc.getLibSoc()!= null && !currentSoc.getLibSoc().equals("")){
			clauseWhere = clauseWhere + "AND upper(o.libSoc) like '%"+currentSoc.getLibSoc()+"%'";
		}
		try{
