...
@Stateless
public class DaoChrHospi extends BaseDao<TabChrHospi, String> implements IDaoChrHospi{
	
	private static BaseLogger logger = BaseLogger.getLogger(DaoChrHospi.class); 
	...
	public <X extends BaseEntity> List<X> findByExample(X entity)
		...
		TabChrHospi currentChrHospi = (TabChrHospi)entity;
		if(currentChrHospi.getNumChrHospi()!= null && !currentChrHospi.getNumChrHospi().equals("")){
			clauseWhere = clauseWhere + "AND upper(o.numChrHospi) like '%"+currentChrHospi.getNumChrHospi()+"%'";
		}
		if(currentChrHospi.getLibChrHospi()!= null && !currentChrHospi.getLibChrHospi().equals("")){
			clauseWhere = clauseWhere + "AND upper(o.libChrHospi) like '%"+currentChrHospi.getLibChrHospi()+"%'";
		}
		try{
