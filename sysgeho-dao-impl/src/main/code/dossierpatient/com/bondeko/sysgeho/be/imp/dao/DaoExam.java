...
public class DaoExam extends BaseDao<TabExam, String> implements IDaoExam {
	...
	public <X extends BaseEntity> List<X> findByExample(X entity)
		...
		if (currentExam != null && currentExam.getCodExam() != null
			...
			clauseWhere = clauseWhere + "AND upper(o.codExam) like '%"
					+ currentExam.getCodExam() + "%'";
		}
		if (currentExam != null && currentExam.getTabPat() != null
			...
			clauseWhere = clauseWhere + "AND upper(o.tabPat.libNom) like '%"
					+ currentExam.getTabPat().getLibNom() + "%'";
		}
		if (currentExam != null && currentExam.getTabTypExam() != null
			...
			clauseWhere = clauseWhere
					+ "AND upper(o.tabTypExam.libTypExam) like '%"
					+ currentExam.getTabTypExam().getLibTypExam() + "%'";
		}
		if (currentExam != null && currentExam.getTabVisMedEmb() != null
			...
			clauseWhere = clauseWhere
					...
					+ currentExam.getTabVisMedEmb().getCodVisMedEmb() + "%'";
		}
		if (currentExam != null
				&& currentExam.getTabVisMedPerio() != null
				&& currentExam.getTabVisMedPerio().getCodVisMedPerio() != null
				&& !currentExam.getTabVisMedPerio().getCodVisMedPerio()
						.equals("")) {
			clauseWhere = clauseWhere
		...
		try {
			String query = "SELECT o FROM " + entity.getClass().getSimpleName()
					+ " o where " + clauseWhere + " ORDER BY o.codExam ";
	...
	public List<TabExam> findExamNonPaieByPatient(String codPat)
			throws SysGehoPersistenceException {
		try {
			String query = "SELECT o FROM TabExam o where o.booPaie='0' AND o.tabPat.codPat='"
					+ codPat + "' ORDER BY o.codExam ";
	...
	public List<TabExam> findByDate(String dateDeb, String dateFin)
		...
		try {
			...
			if (dateDeb != null || dateFin != null) {
				query = "SELECT o FROM  TabExam o " + " WHERE o.datExam >= "
						+ "'" + dateDeb + "'" + " AND o.datExam <= " + "'"
						+ dateFin + "'" + " ORDER BY o.datExam ";
			} else {
