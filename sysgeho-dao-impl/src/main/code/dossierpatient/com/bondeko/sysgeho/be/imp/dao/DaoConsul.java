...
public class DaoConsul extends BaseDao<TabConsul, String> implements IDaoConsul {
	...
	public <X extends BaseEntity> List<X> findByExample(X entity)
		...
		if (currentConsul != null && currentConsul.getCodConsul() != null
			...
			clauseWhere = clauseWhere + "AND upper(o.codConsul) like '%"
					+ currentConsul.getCodConsul() + "%'";
		}
		if (currentConsul != null && currentConsul.getTabPat() != null
			...
			clauseWhere = clauseWhere + "AND upper(o.tabPat.libNom) like '%"
					+ currentConsul.getTabPat().getLibNom() + "%'";
		}
		if (currentConsul != null && currentConsul.getTabUsr() != null
			...
			clauseWhere = clauseWhere + "AND upper(o.tabUsr.libNom) like '%"
					+ currentConsul.getTabUsr().getLibNom() + "%'";
		}
		if (currentConsul != null
				&& currentConsul.getTabVisMedEmb() != null
				&& currentConsul.getTabVisMedEmb().getCodVisMedEmb() != null
				&& !currentConsul.getTabVisMedEmb().getCodVisMedEmb()
						.equals("")) {
		...
		if (currentConsul != null
				&& currentConsul.getTabVisMedPerio() != null
				&& currentConsul.getTabVisMedPerio().getCodVisMedPerio() != null
				&& !currentConsul.getTabVisMedPerio().getCodVisMedPerio()
						.equals("")) {
			clauseWhere = clauseWhere
		...
		try {
			String query = "SELECT o FROM " + entity.getClass().getSimpleName()
					+ " o where " + clauseWhere + " ORDER BY o.datConsul ";
	...
	public List<TabConsul> findByRefFac(String refFac)
			throws SysGehoPersistenceException {
		try {
			String query = "SELECT o FROM TabConsul o where o.refFac='"
					+ refFac + "' ORDER BY o.datConsul ";

			logger.debug("Requete <" + query + ">");

			List<TabConsul> v$list = getManager().createQuery(query)
					.getResultList();
	...
	public List<TabConsul> findConsulNonPaieByPatient(String codPat)
			throws SysGehoPersistenceException {
		try {
			String query = "SELECT o FROM TabConsul o where o.booPaie='0' AND o.tabPat.codPat='"
					+ codPat + "' ORDER BY o.datConsul ";
	...
	public List<TabConsul> findByDate(String dateDeb, String dateFin)
		...
		try {
			...
			if (dateDeb != null || dateFin != null) {
				query = "SELECT o FROM  TabConsul o "
						+ " WHERE o.datConsul >= " + "'"+dateDeb+"'"
						+ " AND o.datConsul <= " + "'"+dateFin+"'"
						+ " ORDER BY o.datConsul ";
			} else {
				query = "SELECT o FROM  o TabConsul ORDER BY o.datConsul ";
			}
