...
@Stateless
public class DaoCatProd extends BaseDao<TabCatProd, String> implements IDaoCatProd{
	
private static BaseLogger logger = BaseLogger.getLogger(DaoCatProd.class); 
			...
			throws SysGehoPersistenceException 
	{
		...
		TabCatProd currentCatProd = (TabCatProd)entity;
		if(currentCatProd.getCodCatProd()!= null && !currentCatProd.getCodCatProd().equals("")){
			clauseWhere = clauseWhere + "AND upper(o.codCatProd) like '%"+currentCatProd.getCodCatProd()+"%'";
		}
		if(currentCatProd.getLibCatProd()!= null && !currentCatProd.getLibCatProd().equals("")){
			clauseWhere = clauseWhere + "AND upper(o.libCatProd) like '%"+currentCatProd.getLibCatProd()+"%'";
		}
		try{
