...
@Stateless
public class DaoSvc extends BaseDao<TabSvc, String> implements IDaoSvc{
	
	private static BaseLogger logger = BaseLogger.getLogger(DaoSvc.class); 
	...
	public <X extends BaseEntity> List<X> findByExample(X entity)
		...
		TabSvc currentSvc = (TabSvc)entity;
		if(currentSvc.getCodSvc()!= null && !currentSvc.getCodSvc().equals("")){
			clauseWhere = clauseWhere + "AND upper(o.codSvc) like '%"+currentSvc.getCodSvc()+"%'";
		}
		if(currentSvc.getLibSvc()!= null && !currentSvc.getLibSvc().equals("")){
			clauseWhere = clauseWhere + "AND upper(o.libSvc) like '%"+currentSvc.getLibSvc()+"%'";
		}
		try{
