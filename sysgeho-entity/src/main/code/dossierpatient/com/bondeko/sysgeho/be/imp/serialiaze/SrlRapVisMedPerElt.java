 ...
 *
 */
public class SrlRapVisMedPerElt {
    ...
    private String datEdi;
	  ...
	  public SrlRapVisMedPerElt() {

	  }
	  
	  public SrlRapVisMedPerElt(TabRapVisMedPerio rapport){

		  try {
			  this.codRapVisMed= rapport.getCodRapVisMedPerio();
		  }catch (Exception e) {
			  this.codRapVisMed=ERROR_VALUE ;
		  }
		  try {
			  this.codVisMed= rapport.getTabVisMedPerio().getCodVisMedPerio();
		  }catch (Exception e) {
			  this.codVisMed=ERROR_VALUE ;
		  }
		  try {
			  this.datVisMed = DateTools.formatDate("dd/MM/yyyy", DateTools
					  .getDateValue(rapport.getTabVisMedPerio().getDatVisMed()));
		  } catch (Exception e) {
		  ...
		  try {
			  this.libVisMedPerio= rapport.getCodRapVisMedPerio();
		  }catch (Exception e) {
			  this.libVisMedPerio=ERROR_VALUE ;
		  }
		  try {
			  this.libSoc= rapport.getTabPat().getTabSoc().getLibSoc();
		  }catch (Exception e) {
			  this.libSoc=ERROR_VALUE ;
		  }
		  try {
			  this.libTit= rapport.getTabPat().getLibTit();
		  }catch (Exception e) {
			  this.libTit=ERROR_VALUE ;
		  }
		  try {
			  this.libMat= rapport.getTabPat().getLibMat();
		  }catch (Exception e) {
			  this.libMat=ERROR_VALUE ;
		  }
		  try {
			  this.libNom= rapport.getTabPat().getLibTit()+ ". " + rapport.getTabPat().getLibNom()+ " " + rapport.getTabPat().getLibPre();
		  }catch (Exception e) {
			  this.libMat=ERROR_VALUE ;
		  }
		  try {
			  this.datNais = DateTools.formatDate("dd/MM/yyyy", DateTools
					  .getDateValue(rapport.getTabPat().getDatNais()));
		  } catch (Exception e) {
			  this.datNais = ERROR_VALUE;
		  }
		  try {
			  this.libNumTel= rapport.getTabPat().getLibNumTel();
		  }catch (Exception e) {
	...
	/**
	 * @param libVisMedPerio the libVisMedPerio to set
	 */
