...
public enum EnuStatutMat {


	MARIE("2000", "Marié"),
	
	DIVORCE("2002", "Divorcé"),
	
	CELIBATAIRE("2003", "Célibataire"),
	 ...
	 */
	private EnuStatutMat(String value, String libelle) {
		this.value = value;
	 ...
	 * @return
	 */
	public static EnuStatutMat getByValue(String enumValue) {
		for (EnuStatutMat enm : EnuStatutMat.class
				.getEnumConstants()) {
	...
	private static List<EnuStatutMat> myList;
	...
	public static List<EnuStatutMat> getListe() {
		return myList;
	}

	static {
		myList = new ArrayList<EnuStatutMat>();
