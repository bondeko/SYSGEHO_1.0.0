package com.bondeko.sysgeho.be.util.locale;
...
public class EntityLocaleUtil {
	...
	private static String DEFAULT_LOCALE_NAME = "com.bondeko.sysgeho.be.messages.locale";
	
	private static String FRENCH_LOCALE_NAME = "com.bondeko.sysgeho.be.messages.locale_fr";
	
	private static String ENGLISH_LOCALE_NAME = "com.bondeko.sysgeho.be.messages.locale_en";
