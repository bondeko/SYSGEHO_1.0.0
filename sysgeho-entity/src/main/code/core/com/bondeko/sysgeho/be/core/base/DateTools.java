...
public class DateTools {
	...
	/***
	 * Aligne à droite, puis complete à gauche une chaine de caractère
	 * @param p$string : Chaine de caractère à padder
	 * @param p$size : La taille maximale de la chaine à retour
	 * @param p$padChar : Caractère de completion
	 * @return String : Nouvelle chaine de caractère aligné à droite et complétée à gauche
	 */
	public static String padRigth(String p$string, int p$size, char p$padChar)
	{
		StringBuffer padded = new StringBuffer(p$string);
		while (padded.length() < p$size)
		{
