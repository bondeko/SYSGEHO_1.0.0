	...
	public void updateDataModel(){
		 ...
		 dataModel = new ExtendedTableDataModel<T>(new DataProvider<T>(){
			...
			public Object getKey(T item) {
				return ((SysGehoBaseEntity) item).getSpecialId();
			}
...
//		}
		...
		remove(((SysGehoBaseEntity) p$entity).getSpecialId());
	}
	...
	public boolean contains(T p$entity){
		...
		boolean bol = contains(((SysGehoBaseEntity) p$entity).getSpecialId());
...
//		return v$index;	
		...
		return getIndexOfEntity(((SysGehoBaseEntity) p$entity).getSpecialId());
