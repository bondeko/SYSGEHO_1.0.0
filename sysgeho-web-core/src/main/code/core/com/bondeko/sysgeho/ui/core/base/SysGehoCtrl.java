...
public abstract class SysGehoCtrl <H extends BaseEntity, T extends H>{
	...
	/**
	 * Méthode appelée juste avant l'insertion ou la modification d'une entité en Base 
	 * Effectuera principalement comme action la validation des données 
	 * 
...
//			v$entiteRecherche.setMaxRow(pasPagination);	
	...
	public String enregistrer() {
		...
		try {
			...
			// Pré-Conditions avant Enregistrement des données
			preEnregistrer();
