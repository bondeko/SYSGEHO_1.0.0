...
import com.bondeko.sysgeho.be.ref.dao.IDaoSpec;
import com.bondeko.sysgeho.be.ref.entity.TabSpec;

@Stateless
public class SisvSpec extends BaseSisv<TabSpec, String> implements ISisvSpec{
	
	private static BaseLogger logger = BaseLogger.getLogger(SisvSpec.class);
	...
	public <X extends BaseEntity> List<X> rechercherParCritere(X entity)
		...
		try {
			return daoSpec.findByExample(entity);
		} catch (SysGehoPersistenceException e) {
			e.printStackTrace();
			SysGehoSystemException sbr = new SysGehoSystemException(e);
			throw sbr;
